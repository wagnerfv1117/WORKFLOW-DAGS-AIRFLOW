...
#3-Crear las etiquetas del operador python que mostrará la información en el panel de Apache Airflow
default_args = {
...
#4-Crear DAG con nombre, etiqueta e intervalo de ejecución
dag = DAG(
...
#5-Crear el operador python que ejecutará la tarea, al dar clic en el panel de Apache airflow
